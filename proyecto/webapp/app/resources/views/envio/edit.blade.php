...
<ul class="nav nav-tabs" role="tablist">
    ...
    <li role="presentation" class="active"><a href="/envio/edit/{{$envio->id}}" aria-controls="profile" role="tab" class="fa fa-pencil">Editar</a></li>
...
<!-- Tab panes -->
<form class="form-horizontal" id="envioForm" method="post">
    <div class="form-group">
        <label for="destinatario" class="col-sm-2 control-label">Destinatario</label>
        <div class="col-sm-10">
            <input type="text" class="form-control" id="destinatario" name="destinatario" placeholder="destinatario" value="{{$envio->destinatario}}">
        </div>
    </div>
    <div class="form-group">
        <label for="direccion" class="col-sm-2 control-label">Dirección</label>
        <div class="col-sm-10">
            <input type="text" class="form-control" id="direccion" name="direccion" placeholder="Dirección" value="{{$envio->direccion}}">
        </div>
    </div>
    <div class="form-group">
...
@section ('footer')
<button class="btn btn-default fa fa-floppy-o" type="button" onclick="document.querySelector('#envioForm input[type=submit]').click();">Guardar</button>
@endsection