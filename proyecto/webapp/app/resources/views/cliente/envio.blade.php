...
@section ('panel') Envios del cliente {{$cliente->cif}} @endsection
            ...
            <tr>
                ...
                <td>
                    <div class="btn-group pull-right">
                        <a href="/cliente/envio/{{$cliente->id}}/info/{{$envio->id}}" class="btn btn-default fa fa-search">Ver</a>
                    </div>
                </td>
            </tr>
            @endforeach
...
@section ('footer')
<a href="/cliente/envio/{{$cliente->id}}/add" class="btn btn-default fa fa-user-plus">Nuevo envio</a>
@endsection